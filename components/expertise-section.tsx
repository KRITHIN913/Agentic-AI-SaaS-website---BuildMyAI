            ...
            <motion.div variants={itemVariants} className="lg:col-span-8 space-y-6">
              <div className="space-y-2">
                <div className="flex items-center space-x-3">
                  <h2 className="text-2xl font-bold">BUILDMYAI™</h2>
                  <motion.div
              ...
              <h3 className="text-3xl sm:text-4xl font-bold leading-tight">
                BuildMyAi is a platform of specialized Virtual Assistants that use advanced Fine-Tuned models to automate daily administrative tasks for professionals. We also offer a range of dedicated AI coaches to provide expert guidance in areas like startups, health, and finance. Our mission is to provide you with intelligent, on-demand support for every part of your life and career.
              </h3>
            </motion.div>
          </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-2 pb-4">
                    <div className="flex items-start space-x-2">
                      ...
                      <p className="text-xs text-muted-foreground italic">
                        "Their expertise in GenAI and business systems transformed my operations completely."
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2 pt-2">
                    ...
                    >
                      ...
                      <span className="font-medium">B2C Partners</span>
                    </motion.div>
                    <motion.div
                      initial={{ opacity: 0, scale: 0 }}
                      animate={{ opacity: 1, scale: 1 }}
                ...
                <div className="space-y-6">
                  <div className="space-y-4">
                    ...
                    <p className="text-muted-foreground">
                      We transform the future, AI is the future, and we are the architects of that future.
                    </p>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="space-y-1">
                      ...
                      <p className="text-sm">Making of Finance Ai Coach</p>
                    </div>
                ...
                <div className="space-y-4">
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    ...
                    <div className="flex items-center space-x-2 px-3 py-2 bg-background/50 backdrop-blur-sm border border-border/30 rounded-full self-start lg:self-center">
                      ...
                      <img src="/images/BMA-logo.png" alt="BuildMyAI" className="h-6" />
                    </div>
                  </div>
