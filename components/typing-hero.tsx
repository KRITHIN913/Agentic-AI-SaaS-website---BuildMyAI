...
export function TypingHero() {
  ...
  const phrases = [
    { text: " Virtual Assistant ", color: "text-emerald-400", cursorColor: "bg-emerald-400" },
    { text: " Ai Coach ", color: "text-orange-400", cursorColor: "bg-orange-400" },
  ]

  const baseText = "Let's Fine Tune Your"
