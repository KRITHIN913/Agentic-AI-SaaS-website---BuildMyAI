...
const services = [
  {
    ...
    subtitle: "Personalization, Multi-Agent, Flexibility, AI Integration",
    description:
      "Your work is unique, and your assistant should be too. Our Customizable Virtual Assistant offers the flexibility to build a multi-AI agent tailored to your specific needs. Start with a foundational assistant and then add specialized agents for tasks like project management, data analysis, or creative content generation. This is the ultimate tool for professionals who need a solution that fits their workflow, not the other way around. It’s an adaptable, intelligent partner that grows with you, learning from your feedback to become an indispensable part of your success.",
    icon: <Globe className="w-8 h-8" />,
    features: [
      { icon: <Rocket className="w-5 h-5" />, text: "Modular AI Agents" },
      { icon: <Shield className="w-5 h-5" />, text: "Personalized Workflows" },
      { icon: <Gauge className="w-5 h-5" />, text: "Seamless Integration" },
    ],
    stats: [
  ...
  },
  {
    id: "mobile",
    title: "Startup Coach",
    subtitle: " Startup, Entrepreneurship, Mentoring",
    description:
      "Our Customizable Virtual Assistant offers the flexibility to build a multi-AI agent tailored to your specific needs. It's an adaptable, intelligent partner that grows with you, learning from your feedback to become an indispensable part of your success.",
    icon: <Smartphone className="w-8 h-8" />,
    features: [
      { icon: <Users className="w-5 h-5" />, text: "Idea Validation" },
      { icon: <Zap className="w-5 h-5" />, text: "Real-time scenario based suggestions" },
      { icon: <Lock className="w-5 h-5" />, text: "Strategic Planning" },
      { icon: <BarChart className="w-5 h-5" />, text: "Leadership Development" },
    ],
    stats: [
  ...
  },
  {
    ...
    subtitle: "Administration, Scheduling, Task Management",
    description:
      "Let our AI Administrative Assistant handle the daily grind. This AI is your expert in automating routine tasks like scheduling meetings, managing your calendar, and handling data entry, ensuring your operations run smoothly and accurately.",
    icon: <Laptop className="w-8 h-8" />,
    features: [
      { icon: <Cog className="w-5 h-5" />, text: "Automated Scheduling" },
      { icon: <Database className="w-5 h-5" />, text: "Calendar Synchronization" },
      { icon: <Cloud className="w-5 h-5" />, text: "Data Entry & Management" },
  ...
  },
  {
    ...
    subtitle: "Finance, Budgeting, Investing,",
    description:
      "The AI Productivity Assistant helps you master your to-do list by cutting through noise and prioritizing tasks based on urgency and importance. It learns your work patterns to optimize your workload, freeing up your mental energy for high-impact projects.",
    icon: <Cog className="w-8 h-8" />,
    features: [
      { icon: <Lightbulb className="w-5 h-5" />, text: "Behavioral Finance" },
      { icon: <Code className="w-5 h-5" />, text: "Budgeting & Planning" },
      { icon: <Package className="w-5 h-5" />, text: "Debt Management" },
  ...
  },
  {
    ...
    subtitle: "Productivity, Task Management, Time Management",
    description:
      "The AI Productivity Assistant helps you master your to-do list by cutting through noise and prioritizing tasks based on urgency and importance. It learns your work patterns to optimize your workload, freeing up your mental energy for high-impact projects.",
    icon: <Package className="w-8 h-8" />,
    features: [
      { icon: <Target className="w-5 h-5" />, text: "Intelligent Task Prioritization" },
      { icon: <Rocket className="w-5 h-5" />, text: "Time Blocking" },
      { icon: <TrendingUp className="w-5 h-5" />, text: "Distraction Management" },
  ...
  },
  {
    ...
    subtitle: "Health, Wellness, Fitness, Mindfulness",
    description:
      "The AI Health & Wellness Coach is an empowering partner dedicated to your holistic health. It helps you set achievable goals for physical activity, nutrition, and sleep, using insights from behavioral science to build sustainable habits and resilience.",
    icon: <Building2 className="w-8 h-8" />,
    features: [
      { icon: <Lightbulb className="w-5 h-5" />, text: "Behavior Change" },
      { icon: <Layers className="w-5 h-5" />, text: "Stress Management" },
      { icon: <Shield className="w-5 h-5" />, text: "Personalized Goals" },
      { icon: <Award className="w-5 h-5" />, text: "Inner Engineering" },
    ],
    stats: [
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
            Comprehensive Fine-Tuned solutions designed to accelerate your business growth and digital transformation
          </p>
        </motion.div>
