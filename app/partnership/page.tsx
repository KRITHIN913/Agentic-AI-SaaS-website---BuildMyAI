        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          <div className="text-center">
              ...
              <div className="relative bg-gradient-to-br from-gray-900/80 to-black/80 backdrop-blur-xl border-2 border-emerald-500/30 rounded-3xl p-12 shadow-2xl shadow-emerald-500/10">
                <div className="flex flex-col items-center space-y-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <img src="/images/BMA-logo.png" alt="BuildMyAi" className="w-80 h-20 object-contain" />
                  </div>
                  <div className="text-center">
            ...
            >
              ...
              <span className="text-emerald-400 font-bold">$10,000</span>. No long-term commitments, remove anytime
