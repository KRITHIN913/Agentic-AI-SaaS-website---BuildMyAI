    ...
    <main className="relative min-h-screen bg-black text-foreground overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-[1] pointer-events-none">
        <video
          ...
          style={{
            filter: "contrast(1.2) brightness(0.7) grayscale(0%)",
          }}
        >
          <source src="/videos/the-ai-revolution.mp4" type="video/mp4" />
          ...
          <div className="max-w-4xl mx-auto text-center space-y-6">
            ...
            <div className="relative">
              ...
              <p className="relative z-10 text-muted-foreground max-w-xl mx-auto font-medium">
                Meet BuildMyAi: The Smartest Way to Manage Your Day. Stop Paying for Tasks, Start Investing In A Solution.
              </p>
            </div>
