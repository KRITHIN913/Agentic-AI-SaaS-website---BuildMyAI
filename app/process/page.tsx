...
export default function ProcessPage() {
  ...
  const tools = [
    ...
    },
    {
      ...
      tools: ["Pycharm","Jupyter","GitHub", "Docker", "AWS/Vercel", "PostgreSQL"],
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              This process is for all our Clents whose neeeds are unique and rerquirements our special. We at BuilMyAi, provide them with our coustomised Virtual Assistant understanding their needs and requirements.
            </p>
          </motion.div>
          ...
          >
            <h2 className="text-2xl font-bold mb-8 text-center">Our 5-Step Process</h2>
