...
export default function ConsultationPage() {
  ...
  const projectTypes = [
    ...
    },
    {
      ...
      color: "blue",
      description: "Administral Control",
    },
    {
      id: "VA",
      label: "My Virtual Assistant",
    ...
    {
      id: "mechanical",
      label: "Ai Health & Welllness Coach",
    ...
    },
    {
      ...
      color: "indigo",
      description: "Startup Related Help",
    },
  ]

  const budgetRanges = [
    { id: "1k-5k", label: "$1K - $5K", description: "Coustomizable Personal Assistants", icon: "1️⃣" },
    { id: "5k-25k", label: "$5K - $25K", description: "MultiAgent systems", icon: "💡" },
    { id: "25k-100k", label: "$25K - $100K", description: "Ai solutions", icon: "🚀" },
    { id: "100k-500k", label: "$100K - $500K", description: "Ai Enterprise", icon: "🏢" },
  ...
  const businessGoals = [
    { id: "increase-sales", label: "Boost Productivity", icon: <TrendingUp className="w-5 h-5" />, color: "emerald" },
    { id: "improve-productivity", label: "Improve Efficiency", icon: <Rocket className="w-5 h-5" />, color: "blue" },
    { id: "expand-market", label: "Automate Tasks", icon: <Target className="w-5 h-5" />, color: "purple" },
    { id: "reduce-costs", label: "Reduce Costs", icon: <BarChart className="w-5 h-5" />, color: "green" },
    { id: "modernize", label: "Revolutionalise with AI", icon: <Sparkles className="w-5 h-5" />, color: "orange" },
                ...
                {currentStep === 6 && (
                  <div className="space-y-6">
                    <div className="text-center space-y-2">
                      ...
                      <p className="text-gray-400">All fields are required to proceed</p>
                    </div>
                    ...
                    <div className="max-w-2xl mx-auto">
                      ...
                      <div className="mt-6 p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-xl">
                        ...
                        <p className="text-gray-300 text-sm">
                          All fields are required to ensure we can provide you with the most accurate consultation and follow-up.
                        </p>
                      </div>
                    </div>
                  </div>
