  ...
  const services = [
    {
      ...
      description: "This focuses directly on the core benefit: helping the user get more work done and be more efficient.",
      features: ["Gen AI", "LLM", "Notion", "API Integration", "Secured Data"],
    ...
    },
    {
      ...
      description: "This is a more specific and practical option that clearly communicates that the AI will handle day-to-day tasks.",
      features: ["Gen AI", "LLM", "Jira", "API Integration", "Secured Data"],
    ...
    },
    {
      ...
      description: "Our Best-in-Class AI Assistant for all your tasks specifically cartered and coustomised for all your personal and business needs",
      features: ["Gen AI", "LLM", "Jira", "API Integration", "Secured Data"],
    ...
    },
    {
      ...
      title: "Ai Health & Welllness Coach",
      description: "Develop sustainable habits for nutrition, exercise, and sleep. Implement strategies to reduce stress and prevent burnout. Create a manageable plan that aligns with your unique lifestyle and needs.",
      features: ["Gen AI", "LLM", "HealthIOS", "API Integration", "Secured Data"],
    ...
    },
    {
      ...
      description: "Understand your spending habits and emotional relationship with money. Create a clear budget and actionable financial plans. Develop strategies to pay down debt and build savings.",
      features: ["Gen AI", "LLM", "FinanceIOS", "API Integration", "Secured Data"],
    ...
    },
    {
      ...
      title: "Your Startup Coach",
      description: " Refine your value proposition and assess market demand.  Create milestones, prioritize growth, and build a clear roadmap.  Sharpen your decision-making and communication skills.",
      features: ["Gen AI", "LLM", "FinanceIOS", "API Integration", "Secured Data"],
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-6xl font-bold mb-8 leading-tight">
              <span className="text-white">Transform Your Life with Our  </span>
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 to-blue-400">
                AI Agents
              </span>
            </h1>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-12">
              From concept to launch, we deliver cutting-edge AI agents that drive growth and exceed expectations
            </p>
          </motion.div>
